...
export function CarListPage(props: CarListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCars({
        relations: ['fleet_manager', 'booking.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['make.contains', 'model.contains', 'location.contains', 'status.contains'],
        ...(params.filters || {}),
      }),
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link
              ...
              href={`/fleet-managers/view/${record.fleet_manager?.id}`}
            >
              {record.fleet_manager?.id}
            </Link>
          ),
        }
      : null,
