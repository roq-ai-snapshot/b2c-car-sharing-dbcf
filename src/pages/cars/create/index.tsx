...
function CarCreatePage() {
  ...
  const formik = useFormik<CarInterface>({
    initialValues: {
      ...
      location: '',
      status: '',
      fleet_manager_id: (router.query.fleet_manager_id as string) ?? null,
    },
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <AsyncSelect<FleetManagerInterface>
            formik={formik}
            name={'fleet_manager_id'}
            label={'Select Fleet Manager'}
            placeholder={'Select Fleet Manager'}
