  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to B2C Car Sharing v3, where individual customers seamlessly book cars nearby, powered by efficient operations managed from centralized dashboards."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to B2C Car Sharing v3, where individual customers seamlessly book cars nearby, powered by efficient operations managed from centralized dashboards.`}
            </Text>
            <Box
