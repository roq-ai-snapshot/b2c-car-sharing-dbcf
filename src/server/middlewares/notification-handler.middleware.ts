...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'car.create': { roles: ['owner', 'admin'], key: 'new-car-added', tenantPath: [], userPath: [] },
  'car.update': { roles: ['owner', 'admin'], key: 'car-status-updated', tenantPath: [], userPath: [] },
  'car.delete': { roles: ['owner', 'admin'], key: 'car-deleted', tenantPath: [], userPath: [] },
  'booking.create': { roles: ['owner', 'fleet-manager', 'admin'], key: 'new-booking', tenantPath: [], userPath: [] },
  'booking.delete': {
