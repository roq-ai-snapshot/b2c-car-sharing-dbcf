...
-- AddForeignKey
ALTER TABLE "car" ADD CONSTRAINT "car_fleet_manager_id_fkey" FOREIGN KEY ("fleet_manager_id") REFERENCES "fleet_manager"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
